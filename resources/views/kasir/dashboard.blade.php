...
@section('content')
    <div class="p-6">
        <div class="mb-8">
            ...
            <p class="text-gray-600">Selamat datang di panel kasir Nasi Goreng Mas Reno</p>
        </div>

        <!-- Date Filter -->
        <div class="bg-white rounded-lg shadow p-4 mb-6">
            <form action="{{ route('kasir.dashboard') }}" method="GET" class="flex flex-wrap items-end gap-4">
                <div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-800">Rp. {{ number_format($totalRevenue, 0, ',', '.') }}
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($recentTransactions as $transaction)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <a href="{{ route('kasir.transaction.receipt', $transaction->id) }}"
